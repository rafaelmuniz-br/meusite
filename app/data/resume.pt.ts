...
export const resumePt: ResumeContent = {
  ...
  // "summary": frase curta sempre visível. "highlights": lista detalhada dentro do
  // dropdown (<details>), escrita no método XYZ com números reais.
  experiences: [
    {
    ...
    },
    {
      ...
      summary: 'Formação de professores em Computação e desenvolvimento do site do PROFCOMP.',
      highlights: [
  ...
  // Descrições focadas nas atividades de desenvolvimento — sem afirmar vínculo/parceria.
  portfolio: [
    {
